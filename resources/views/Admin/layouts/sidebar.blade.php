      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="page-layouts">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="{{ URL::to('dashboard/Sales/list') }}">Sales Commission Agents</a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> <a class="nav-link" href="{{ URL::to('dashboard/Product/selling')}}">Selling Price Group</a></li>
            ...
            <li class="nav-item"> <a class="nav-link" href="{{ URL::to('dashboard/Product/brand')}}">Brands</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{ URL::to('dashboard/Product/warranties')}}">Warranties</a></li>
          </ul>
          </div>
      </li>
      <li class="nav-item">
