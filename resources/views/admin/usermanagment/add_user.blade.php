                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{-- <label for="vehicle1"> All Locations </label> --}}
                                            <label>
                                                <input class="checkbox" name="Access_location" type="checkbox" value="Bike">All Locations
                                            </label>
                                            <i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true"
                                                data-container="body" data-toggle="popover" data-placement="auto bottom"
                                                data-content="Check/Uncheck to make a user active/inactive."
                                            ...
                                            {{-- <label for="vehicle2"> Awesome Shop</label><br> --}}
                                            <input class="checkbox" name="Access_location" type="checkbox" value="Car">Awesome Shop<br>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Sales Commission Percentage (%)"
                                                name="Sales Commission" type="text" id="Sales_Commission">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Max sales discount percent:"
                                                name="discount percent" type="text" id="discount_percent">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder=" Alternate Mobile Number"
                                                name="Alternate_num" type="number" id="Alternate">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="family contact Number "
                                                name="Familycontact_num" type="number" id="family_Number">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Social Media 1"
                                                name="Social_media1" type="text" id="Social_Media_1">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Social Media 2"
                                                name="Social_media2" type="text" id="Social_Media_2">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Custom field 1"
                                                name="Custom_field1" type="text" id="Custom_field_1">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Custom field 2"
                                                name="Custom_field2" type="text" id="Custom_field_2">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Custom field 3"
                                                name="Custom_field3" type="text" id="Custom_field_3">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Custom field 4"
                                                name="Custom_field4" type="text" id="Custom_field_4">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="ID proof number:"
                                                name="ID_proof_number" type="text" id="ID proof number">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Account Holder's Name"
                                                name="Account_Holder's_Name" type="text" id="Account_Holder's_Name">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Account Number"
                                                name="Account_Number" type="text" id="Account_Number">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Bank Identifier Code"
                                                name="Bank_Identifier_Code" type="text" id="Bank_Identifier_Code">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Pay Components:"
                                                name="Pay_Components" type="text" id="Pay_Components">
                                        </div>
                                    </div>
                                </div>
                            </div>
