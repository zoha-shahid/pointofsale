        ...
        <div class="content-wrapper">
          ...
          <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-4">
              <h4 class="card-title"><b>All Customer Groups</b></h4>
                    </div>
                    <div class="col-md-6">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 2em">
                                ...
                                <a href="{{url('/dashboard/user/delete/' )}}" ><button type="button"  style="padding:0.8em 2em" class="btn btn-danger">Delete<i class="fa fa-trash"></i></button></a>
                                <a href="{{url('/dashboard/user/view/')}}" ><button type="button"  style="padding:0.8em 2em" class="btn btn-warning">view<i class="fa-regular fa-eye"></i></button></a>
