                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="container">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" placeholder="Alternate Mobile"
                                                                name="Alternate-Mobile" type="text" id="Alternate-Mobile">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                ...
                                                <br>
                                                <div id="divone">
                                                    <hr style="height: 1px;boder-width:0;color:black;background-color:black">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Opening Balance"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Address line 1"
                                                                    name="Address-line-1" type="text" id="Address-line-1">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Custom Field 1"
                                                                    name="Custom-Field-1" type="text" id="Custom-Field-1">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Custom Field 2"
                                                                    name="Custom Field 2" type="text" id="Custom Field 2">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Custom Field 3"
                                                                    name="Custom Field 3" type="text" id="Custom Field 3">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Custom Field 4"
                                                                    name="Custom Field 4" type="text" id="Custom Field 4">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Custom Field 5"
                                                                    name="Custom-Field-5" type="text" id="Custom-Field-5">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <strong><label>Custom Field 6:</label></strong>
                                                                <input class="form-control" placeholder="Custom Field 6"
                                                                    name="Custom Field 6" type="text" id="Custom Field 6">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <strong><label>Custom Field 7:</label></strong>
                                                                <input class="form-control" placeholder="Custom Field 7"
                                                                    name="Custom Field 7" type="text" id="Custom Field 7">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <strong><label>Custom Field 8:</label></strong>
                                                                <input class="form-control" placeholder="Custom Field 8"
                                                                    name="Custom Field 8" type="text" id="Custom Field 8">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder="Custom Field 9"
                                                                    name="Custom-Field-9" type="text" id="Custom-Field-9">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <strong><label>Custom Field 10:</label></strong>
                                                                <input class="form-control" placeholder="Custom Field 10"
                                                ...
                                                <div class="row" id="divtwo">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-2 ">
                                                                <div class="form-group">
                                                                    <strong> <label>Prefix:</label></strong>
                                                                    <input class="form-control" placeholder="Mr / Mrs / Miss"
                                                                        name="cp1-prefix" type="text" id="cp1-prefix">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5 ">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <strong> <label>Email:</label></strong>
                                                                    <input class="form-control" placeholder="Email"
                                                                        name="cp1-Email" type="text" id="cp1-Email">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input class="form-control" required=""
                                                                            ...
                                                                            id="cp1-mobile-number" aria-required="true">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control"
                                                                        ...
                                                                        name="cp1-Alternate-contact-number" type="text"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input class="form-control" required=""
                                                                            ...
                                                                            name="cp1-Family-contact-number:" type="text"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input class="form-control" required=""
                                                                            placeholder="Designation" name="cp1-Designation:"
                                                                            type="text" id="cp1-Designation"
                                                                            aria-required="true">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="container mt-3">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="checkbox" id="prsn1" name="prsn1"
                                                                        value="loginps1">
                                                ...
                                                <div class="row"id="div3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-2 ">
                                                                <div class="form-group">
                                                                    <strong> <label>Prefix:</label></strong>
                                                                    <input class="form-control" placeholder="Mr / Mrs / Miss"
                                                                        name="cp2-prefix" type="text" id="cp2-prefix">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5 ">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <strong> <label>Email:</label></strong>
                                                                    <input class="form-control" placeholder="Email"
                                                                        name="cp2-Email" type="text" id="cp2-Email">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input class="form-control" required=""
                                                                            ...
                                                                            id="cp2-mobile-number" aria-required="true">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control"
                                                                        placeholder="Alternate contact number"
                                                                        name="cp2-Alternate-contact-number" type="text"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input class="form-control" required=""
                                                                            placeholder="Family contact number"
                                                                            name="cp2-Family-contact-number:" type="text"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input class="form-control" required=""
                                                                            placeholder="Designation" name="cp2-Designation:"
                                                                            type="text" id="cp2-Designation"
                                                                            aria-required="true">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="container mt-3">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="checkbox" id="prsn2" name="prsn2"
                                                                        value="loginps2">
                                                                    <label for="vehicle1"> Allow login</label><br>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row"id="div4">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-2 ">
                                                                <div class="form-group">
                                                                    <strong> <label>Prefix:</label></strong>
                                                                    <input class="form-control" placeholder="Mr / Mrs / Miss"
                                                                        name="cp3-prefix" type="text" id="cp3-prefix">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5 ">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <strong> <label>Email:</label></strong>
                                                                    <input class="form-control" placeholder="Email"
                                                                        name="cp3-Email" type="text" id="cp3-Email">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input class="form-control" required=""
                                                                            ...
                                                                            id="cp3-mobile-number" aria-required="true">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control"
                                                                        placeholder="Alternate contact number"
                                                                        name="cp3-Alternate-contact-number" type="text"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input class="form-control" required=""
                                                                            placeholder="Family contact number"
                                                                            name="cp3-Family-contact-number:" type="text"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input class="form-control" required=""
                                                                            placeholder="Designation" name="cp3-Designation:"
                                                                            type="text" id="cp3-Designation"
                                                                            aria-required="true">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="container mt-3">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="checkbox" id="prsn3" name="prsn3"
                                                                        value="loginps3">
                                                                    <label for="vehicle1"> Allow login</label><br>
                                                                </div>
                                                            </div>
